...
const cacheName = "{{ parse_url( $app['site_url'] . $app['base_route'], PHP_URL_HOST ) }}-{{ ( !empty($app['debug']) ? time() : '0.0.1' ) }}";
const startPage = "{{ $app['site_url'] . $app['base_route'] }}";
const offlinePage = "{{ $app['site_url'] . $app['base_route'] }}";
const filesToCache = [startPage, offlinePage];
const neverCacheUrls = [/\/admin/,/\/login/,/preview=true/];
