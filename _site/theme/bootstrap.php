...
$app = new LimeExtra\App(
  [
    ...
    [
      ...
      'views'          => ABSPATH . '/_site/theme/views',
      'blocks'         => ABSPATH . '/_site/theme/views/blocks',
      'layouts'        => ABSPATH . '/_site/theme/views/layouts',
      'partials'       => ABSPATH . '/_site/theme/views/partials',
    ]),
