...
@if(!empty($page['image']))
<meta property="og:image" content="@base('#uploads:'.$page['image'])">
<meta property="og:image:secure_url" content="@base('#uploads:'.$page['image']['path'])">
@endif
...
@if(!empty($page['image']))
<meta name="twitter:image:src" content="@base('#uploads:'.$page['image']['path'])">
@endif
